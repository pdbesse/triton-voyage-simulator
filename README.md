# Triton
[![CI](https://github.com/pdbesse/triton-voyage-simulator/actions/workflows/python-tests.yml/badge.svg)](https://github.com/pdbesse/triton-voyage-simulator/actions/workflows/python-tests.yml)
